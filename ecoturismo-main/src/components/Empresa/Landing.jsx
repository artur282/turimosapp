      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="relative grid max-w-4xl mx-auto space-y-5 sm:space-y-10">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-gray-800 sm:text-5xl lg:text-6xl lg:leading-tight dark:text-gray-200">
              Acerca de <span className="text-emerald-500">EcoTurismo </span>
              <span className="text-teal-500">Coorporativo</span>
            </h1>
          </div>
          <div className="flex flex-col text-center sm:justify-center sm:items-center sm:text-left">
            <p className="text-base font-medium text-gray-600 sm:text-lg">
              Se fundó en 2023 por un grupo de emprendedores locales comprometidos con el desarrollo sostenible y la preservación del
              patrimonio cultural y natural de la región. Desde entonces, hemos trabajado en colaboración con las comunidades locales para
              ofrecer experiencias únicas y auténticas a nuestros visitantes, promoviendo el turismo responsable y generando oportunidades
          ...
          <div>
            <h4 className="mt-16 text-3xl font-bold text-gray-800 sm:text-4xl lg:text-5xl lg:leading-tight dark:text-gray-200">
              Nuestra <span className="text-emerald-500">Misión</span>
            </h4>
            <p className="text-base font-medium text-gray-600 sm:text-lg">
              Es promover el turismo sostenible y responsable, fomentando el desarrollo económico y social de las comunidades locales,
              preservando la cultura y el medio ambiente.
            </p>
            <h4 className="mt-16 text-3xl font-bold text-gray-800 sm:text-4xl lg:text-5xl lg:leading-tight dark:text-gray-200">
              Nuestra <span className="text-emerald-500">Visión</span>
            </h4>
            <p className="text-base font-medium text-gray-600 sm:text-lg">
              Ser líderes en turismo ecológico y comunitario en la región, brindando una experiencia única y auténtica a nuestros
              visitantes.
            </p>
            <h4 className="mt-16 text-3xl font-bold text-gray-800 sm:text-4xl lg:text-5xl lg:leading-tight dark:text-gray-200">
              Nuestros <span className="text-emerald-500">Valores</span>
            </h4>
            <ul className="flex flex-col gap-2 mt-2 text-2xl sm:mt-4 sm:flex-row">
              <li className="inline-flex items-center gap-1">
                <HiOutlineCheck className="text-3xl text-emerald-500" />
                <p>Sostenibilidad</p>
              </li>
              <li className="inline-flex items-center gap-1">
                <HiOutlineCheck className="text-3xl text-emerald-500" />
