...
const Contacto = () => {
  ...
  return (
    <>
      <div className="">
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="relative grid max-w-4xl mx-auto space-y-5 sm:space-y-10">
            <div className="text-center">
              <h1 className="text-3xl font-bold text-gray-800 sm:text-5xl lg:text-6xl lg:leading-tight dark:text-gray-200">Contáctanos</h1>
            </div>
            <div className="flex flex-col text-center sm:justify-center sm:items-center sm:text-left">
              <div className="grid items-center gap-6 lg:gap-2 sm:grid-cols-2 lg:grid-cols-4">
                <Link to={"?l=Contacto@ecoturismo.com"} className="inline-flex items-center gap-3 lg:justify-center">
                  <div className="p-2 bg-gray-800 rounded-full">
                    <IoMailOutline className="w-6 h-6 text-white" />
                  </div>
                  Contacto@ecoturismo.com
                </Link>
                <Link to="?l=Instagram" className="inline-flex items-center gap-3 lg:justify-center">
                  <div className="p-2 bg-gray-800 rounded-full">
                    <BsInstagram className="w-6 h-6 text-white" />
                  </div>
                  Instagram
                </Link>
                <Link to="?l=Facebook" className="inline-flex items-center gap-3 lg:justify-center">
                  <div className="p-2 bg-gray-800 rounded-full">
                    <BsFacebook className="w-6 h-6 text-white" />
                  </div>
                  Facebook
                </Link>
                <Link to="?l=Twitter" className="inline-flex items-center gap-3 lg:justify-center">
                  <div className="p-2 bg-gray-800 rounded-full">
            ...
            <div
              className="absolute left-0 hidden transform -translate-x-40 top-2/4 -translate-y-2/4 md:block lg:-translate-x-80"
              aria-hidden="true"
            >
              <svg className="h-auto w-52" width="717" height="653" viewBox="0 0 717 653" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <div
              className="absolute right-0 hidden transform translate-x-40 top-2/4 -translate-y-2/4 md:block lg:translate-x-80"
              aria-hidden="true"
            >
              <svg className="h-auto w-72" width="1115" height="636" viewBox="0 0 1115 636" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div className="max-w-screen-md px-4 py-8 mx-auto lg:py-16">
            <h2 className="mb-4 text-2xl font-bold tracking-tight text-center text-gray-900 dark:text-white">
            ...
            <form autoComplete="off" onSubmit={hadleSubmit} className="space-y-8">
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  className="px-5 py-3 text-sm font-medium text-center text-white rounded-lg bg-emerald-700 sm:w-fit hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800"
                >
                  Enviar Mensaje
                </button>
              </div>
      ...
      <Suspense>
        <ModalComplet isOpen={isVisible} setIsOpen={setIsVisible} />
      </Suspense>
    </>
  );
};
